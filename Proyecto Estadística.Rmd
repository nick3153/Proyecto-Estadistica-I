...
-   **3.4.** Conjunto de datos final: Realizada la limpieza de datos, debemos mencionar que esta fue realizada a cad uno de los 48 meses con los que trabajamos, por lo tanto, mostramos una visra general de uno de los mese (que se repite en los demás meses)
...
En la obtención de los datos podemos ver que promedio de los datos de 2019 y 2020 no hubo tanta variación, en promedio, sin embargo, podemos obeservar que existieron aduanas donde su cobro máximo alcanzó el valor más alto de los 4 años, reflejando que este costo se llegó a incremente abismalmente por las medidas de bioseguridad implementadas.
