...
años <- list(nombre_tablas_2019, nombre_tablas_2020, nombre_tablas_2021, nombre_tablas_2022)
...
for (año_tablas in años) {
  ...
  ggplot(transportes_totales, aes(x = Mes, y = Cantidad, fill = factor(Tipo_Transporte))) +
    geom_bar(stat = "identity", position = "stack", color = "black") +
    scale_fill_brewer(palette = "Set3") +  # Cambiar la paleta de colores para mejor visualización
    theme_minimal() +
    labs(
      title = paste("Cantidad Total de Transportes por Mes -", gsub("_.*", "", año_tablas[1])),
      x = "Mes",
