...
#Donde se conecta con los .CSV??
nombre_tablas_2019 <- c("Enero_2019", "Febrero_2019", "Marzo_2019", "Abril_2019", "Mayo_2019",
                        "Junio_2019", "Julio_2019", "Agosto_2019", "Septiembre_2019", "Octubre_2019", 
                        "Noviembre_2019", "Diciembre_2019")
                        
nombre_tablas_2020 <- c("Enero_2020", "Febrero_2020", "Marzo_2020", "Abril_2020", "Mayo_2020", 
                        "Junio_2020", "Julio_2020", "Agosto_2020", "Septiembre_2020", "Octubre_2020", 
                        "Noviembre_2020", "Diciembre_2020")
nombre_tablas_2021 <- c("Enero_2021", "Febrero_2021", "Marzo_2021", "Abril_2021", "Mayo_2021", 
                        "Junio_2021", "Julio_2021", "Agosto_2021", "Septiembre_2021", "Octubre_2021", 
                        "Noviembre_2021", "Diciembre_2021")
nombre_tablas_2022 <- c("Enero_2022", "Febrero_2022", "Marzo_2022", "Abril_2022", "Mayo_2022", 
                        "Junio_2022", "Julio_2022", "Agosto_2022", "Septiembre_2022", "Octubre_2022", 
                        "Noviembre_2022", "Diciembre_2022")

nombre_columnas <- c("PBK", "FLETE", "VACID", "VADUA")


#LIMPIEZA DE DATOS

# ANGELA: Función para convertir las columnas de cada tabla
convertir_columnas <- function(nombre_tablas, nombre_columnas) {
...
Operaciones para las importaciones totales por año:
...
impo_total_2019 <- calcular_importacion_total(nombre_tablas_2019)
impo_total_2020 <- calcular_importacion_total(nombre_tablas_2020)
impo_total_2021 <- calcular_importacion_total(nombre_tablas_2021)
impo_total_2022 <- calcular_importacion_total(nombre_tablas_2022)
...
# Calcular las importaciones totales para cada año
flete_total_2019 <- calcular_flete_total(nombre_tablas_2019)
flete_total_2020 <- calcular_flete_total(nombre_tablas_2020)
flete_total_2021 <- calcular_flete_total(nombre_tablas_2021)
flete_total_2022 <- calcular_flete_total(nombre_tablas_2022)
...
ggplot(fletes_totales, aes(x = factor(Año), y = Flete_Total)) +
  geom_col(fill = "#2e2050", color = "black", alpha = 0.8) +
  geom_text(aes(label = scales::comma(Flete_Total)), 
            vjust = -0.5, size = 4) +  # Agregar etiquetas encima de las barras
  theme_minimal() +
...
```{r}
# Función para calcular el total de importaciones por año
transp_total <- function(nombre_tablas) {
  flete_total <- 0
  for(tabla in nombre_tablas) {
    temp_tabla <- get(tabla)
    flete_total <- flete_total + sum(temp_tabla$VIATRANS, na.rm = TRUE)
  }
  return(flete_total)
}
...
# Calcular las importaciones totales para cada año
transp_total_2019 <- transp_total(nombre_tablas_2019)
transp_total_2020 <- transp_total(nombre_tablas_2020)
transp_total_2021 <- transp_total(nombre_tablas_2021)
transp_total_2022 <- transp_total(nombre_tablas_2022)

# Crear un data frame con las importaciones totales por año
transportes_totales <- data.frame(
  Año = c(2019, 2020, 2021, 2022),
  Transp_Total = c(transp_total_2019, transp_total_2020, transp_total_2021, transp_total_2022)
)

# Crear gráfico de barras con ggplot2
ggplot(transportes_totales, aes(x = factor(Año), y = Transp_Total)) +
  geom_col(fill = "#2e2050", color = "black", alpha = 0.8) +
  geom_text(aes(label = scales::comma(Transp_Total)), 
            vjust = -0.5, size = 4) +  # Agregar etiquetas encima de las barras
  theme_minimal() +
  labs(title = "Frecuencia Absoluta de transporte por Año", x = "Año", y = "Frecuencia de Transportes") +
  theme(
    plot.title = element_text(hjust = 0.5)  # Centrar el título
  )
```
